      ...
      ******************************************************************
      * PROGRAM:     STLMT100 (LOCAL GNUCOBOL VERSION)                *
      * DESCRIPTION: SETTLEMENT - DAILY TRANSACTION EXTRACT            *
      *              READS TRANSACTION INPUT FROM CARD NETWORKS,       *
      *              VALIDATES AND FORMATS RECORDS, WRITES TO          *
      *              INDEXED SETTLEMENT TRANSACTION FILE.              *
      * INPUT:       TXNINP   - NETWORK TRANSACTION FILE               *
      * OUTPUT:      STLVSAM  - SETTLEMENT INDEXED FILE                *
      *              STLERR   - REJECTED TRANSACTIONS FILE             *
      *              STLRPT   - EXTRACTION SUMMARY REPORT              *
      * NOTE:        VSAM KSDS -> INDEXED FILE (SAME PATTERN)         *
      ...
      * INPUT NETWORK TRANSACTION LAYOUT
       01  WS-NETWORK-TXN-REC.
           ...
           05  WS-NET-TXN-AMOUNT          PIC 9(11)V99.
           ...
           05  WS-NET-INTERCHANGE-FEE     PIC 9(07)V99.
           05  FILLER                     PIC X(89).
      ...
      * AMOUNT TOTALS
       01  WS-TOTAL-AMOUNT                PIC 9(13)V99
                                          VALUE ZEROS.
       01  WS-TOTAL-FEES                  PIC 9(11)V99
                                          VALUE ZEROS.
      ...
      ******************************************************************
      * 2400-WRITE-VSAM: WRITE RECORD TO INDEXED FILE                 *
      ******************************************************************
       2400-WRITE-VSAM.
           ...
           EVALUATE WS-VSAM-FILE-STATUS
               ...
               WHEN '22'
                   MOVE 'DUPLICATE KEY IN SETTLEMENT FILE'
                       TO WS-ERR-MESSAGE
                   PERFORM 2600-WRITE-ERROR
                   ADD 1 TO WS-RECORDS-REJECTED
               WHEN OTHER
      ...
      ******************************************************************
       ...
       3000-WRITE-SUMMARY.
           ...
           MOVE 'RECORDS WRITTEN TO FILE:   ' TO WS-RPT-SUM-LABEL
           ...
           MOVE WS-EDIT-AMOUNT  TO WS-RPT-SUM-VALUE
           WRITE SETTLE-REPORT-RECORD FROM WS-RPT-SUM-LINE

           MOVE 'TOTAL INTERCHANGE FEES:    ' TO WS-RPT-SUM-LABEL
           MOVE WS-TOTAL-FEES   TO WS-EDIT-AMOUNT
           MOVE WS-EDIT-AMOUNT  TO WS-RPT-SUM-VALUE
           WRITE SETTLE-REPORT-RECORD FROM WS-RPT-SUM-LINE
           .
